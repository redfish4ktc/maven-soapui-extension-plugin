...
log("Verifying jgoodies missing dependency");
checker.assertLogFileContains("java.lang.NoClassDefFoundError: com/jgoodies/looks/plastic/theme/SkyBluer");
log("The jgoodies dependency is missing");
