...
log("Verifying junit missing dependency");
checker.assertLogFileContains("[SoapUI] An error occured [junit/framework/Assert], see error log for details");
log("The junit dependency is missing");
