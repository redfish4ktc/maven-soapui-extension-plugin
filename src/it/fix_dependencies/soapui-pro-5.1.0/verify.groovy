...
log("Verifying reflections missing dependency");
checker.assertLogFileContains("java.lang.NoClassDefFoundError: org/reflections/Configuration");
log("The reflections dependency is missing");
