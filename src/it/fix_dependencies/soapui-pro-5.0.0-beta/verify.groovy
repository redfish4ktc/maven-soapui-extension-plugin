...
log("Verifying license4j missing dependency");
checker.assertLogFileContains("java.lang.NoClassDefFoundError: com/smardec/license4j/License");
log("The license4j dependency is missing");
